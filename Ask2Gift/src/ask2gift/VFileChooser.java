 ...
 * @author inaki
 */
public class VFileChooser extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VFileChooser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new VFileChooser().setVisible(true);
            }
        });
    }
    ...
    /**
     * @param gestorfile the gestorfile to set
     */
    public void setGestorfile(GestorFile gestorfile) {
        this.gestorfile = gestorfile;
    }
}
