 ...
 * @author 7fprog02
 */
public class VEditarCat extends javax.swing.JFrame {

    private Vprincipal vprincipal = null;
    private GestorBD bd;

    /**
     * Creates new form VEditarCat
     */
    public VEditarCat() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Nuevo nombre"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEditarCat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VEditarCat().setVisible(true);
            }
        });
    }
